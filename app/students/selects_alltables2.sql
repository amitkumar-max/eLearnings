...
-- SELECT id, title, slug, order_index FROM lessons_lesson
-- WHERE course_id = 2
-- ORDER BY order_index;


-- Example: lesson 2 should have order_index = 2
-- UPDATE lessons_lesson
-- SET order_index = 2
-- WHERE id = 2;

-- -- Update lesson slug if you want
-- UPDATE lessons_lesson
...
-- id | title                  | slug
-- 2  | Python for Data Science | python-data-science
-- 5  | AI Programming with Python | ai-programming-python
