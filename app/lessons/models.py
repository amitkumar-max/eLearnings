...
# #     slug = models.SlugField(max_length=200, blank=True)
# #     content_file = models.FileField(upload_to='lessons/content/', blank=True, null=True)
# #     content_text = models.TextField(blank=True, null=True)  # new field for DB content
...
#     title = models.CharField(max_length=200)
#     slug = models.SlugField(max_length=200, blank=True, null=False)  # ❌ make null=False
#     content_file = models.FileField(upload_to='lessons/content/', blank=True, null=True)
#     content_text = models.TextField(blank=True, null=True)
#     content_path = models.CharField(max_length=300, blank=True, null=True)
#     order_index = models.PositiveIntegerField(default=1)
#     created_at = models.DateTimeField(auto_now_add=True)
#     updated_at = models.DateTimeField(auto_now=True)
