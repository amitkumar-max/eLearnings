...
-- INSERT INTO admin_adminprofile (user_id, role)
-- VALUES (
--     (SELECT id FROM users_customuser WHERE email='admin@example.com'),
--     'superadmin'
-- )
...
-- CREATE TABLE IF NOT EXISTS admin_adminprofile (
...
-- -- Dummy entry
-- INSERT INTO admin_adminprofile (user_id, role)
-- VALUES ((SELECT id FROM users_customuser WHERE username='admin'), 'superadmin')
-- ON CONFLICT DO NOTHING;
